...
// OnlyControlsDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "OnlyControls.h"
#include "OnlyControlsDlg.h"
...
BEGIN_MESSAGE_MAP(COnlyControlsDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &COnlyControlsDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// COnlyControlsDlg 消息处理程序

BOOL COnlyControlsDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	HWND h = GetDlgItem(IDC_BUTTON1)->m_hWnd;
...
//显示。
HCURSOR COnlyControlsDlg::OnQueryDragIcon()
{
